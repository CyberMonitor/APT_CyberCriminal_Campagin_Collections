...
# Decompiled from: Python 2.7.15 (default, Aug 17 2018, 22:44:41) 
# [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
# Embedded file name: lib\web\utils.py
"""
General Utilities
(part of web.py)
"""
...
def re_subm(pat, repl, string):
    ...
    return (
     compiled_pat.sub(repl, string), proxy.match)
...
class _EmailMessage:
    ...
    def send(self):
        ...
        if webapi.config.get('smtp_server'):
            ...
            import boto.ses
            c = boto.ses.SESConnection(aws_access_key_id=webapi.config.get('aws_access_key_id'), aws_secret_access_key=webapi.config.get('aws_secret_access_key'))
...
if __name__ == '__main__':
    import doctest
    doctest.testmod()
# okay decompiling muddyc3.exe_extracted/PYZ-00.pyz_extracted/lib.web.utils.pyc
